...
@if(!$reviews->isEmpty())
    ...
    <tbody>
        ...
        <td style="font-weight:bold"><h2>Edit</h2></td>
        <td style="font-weight:bold"><h2>Delete</h2></td>
   ...
   @foreach($reviews as $review)
        <tr>
          ...
          <form action="/editreviews" method="GET">
            <button class="btn btn-sm btn-warning mt-2">Edit</button> 
              <input type="hidden" name="id" value={{$review->id}}>
            </form>
    </td>
        <td>
           <form action="/deletereviews" method="GET">
                        <input type="hidden" name="id" value={{$review->id}}>
...
<form action="/createreviewsadmin" method="GET">
